Eeste é um sistema simples desenvolvido em Java que permite aos usuários escolher filmes, selecionar sessões e calcular o valor total da compra de ingressos (inteiros e meia-entrada).
